...
### Scenario: [Scenario with test_method gets test link](#scenario-scenario-with-test_method-gets-test-link) (happy_path)  | [Test](/test/invoke_bot/edit_story_map/test_open_story_related_files.py#L1561)
...
### Scenario: [Scenario test link appears based on test_method and sub-epic test_file](#scenario-scenario-test-link-appears-based-on-test_method-and-sub-epic-test_file) (happy_path)  | [Test](/test/invoke_bot/edit_story_map/test_open_story_related_files.py#L1640)
