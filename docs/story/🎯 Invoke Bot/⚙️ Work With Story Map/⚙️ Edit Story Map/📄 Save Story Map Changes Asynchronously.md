...
**Navigation:** [📄‹ Story Map](../../../../story-map.drawio) | [Test](/test/invoke_bot/edit_story_map/test_edit_story_nodes.js#L2198)
...
### Scenario: [User makes multiple rapid changes and sees batched async save](#scenario-user-makes-multiple-rapid-changes-and-sees-batched-async-save) (happy_path)  | [Test](/test/invoke_bot/edit_story_map/test_edit_story_nodes.js#L2368)
