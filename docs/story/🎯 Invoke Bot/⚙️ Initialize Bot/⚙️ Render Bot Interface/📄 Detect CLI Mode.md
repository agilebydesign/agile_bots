...
### Scenario: [CLI detects TTY mode](#scenario-cli-detects-tty-mode) (happy_path)
...
### Scenario: [CLI detects pipe mode](#scenario-cli-detects-pipe-mode) (happy_path)
...
### Scenario: [CLI accepts JSON mode flag](#scenario-cli-accepts-json-mode-flag) (happy_path)
