...
### Scenario: [CLI session initializes bot (all channels)](#scenario-cli-session-initializes-bot-all-channels) (happy_path)
...
### Scenario: [CLI session loads existing state (all channels)](#scenario-cli-session-loads-existing-state-all-channels) (happy_path)
...
### Scenario: [CLI session can execute commands (all channels)](#scenario-cli-session-can-execute-commands-all-channels) (happy_path)
