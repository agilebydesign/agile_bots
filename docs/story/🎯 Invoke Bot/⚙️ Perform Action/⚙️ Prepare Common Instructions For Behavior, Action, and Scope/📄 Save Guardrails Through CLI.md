...
**Navigation:** [📄‹ Story Map](../../../../story-map.drawio) | [Test](/test/invoke_bot/perform_action/test_prepare_common_instructions_for_behavior_action_and_scope.py#L641)
...
### Scenario: [Save answers via CLI command](#scenario-save-answers-via-cli-command) ()  | [Test](/test/invoke_bot/perform_action/test_prepare_common_instructions_for_behavior_action_and_scope.py#L654)
...
### Scenario: [Save decisions via CLI command](#scenario-save-decisions-via-cli-command) ()  | [Test](/test/invoke_bot/perform_action/test_prepare_common_instructions_for_behavior_action_and_scope.py#L684)
