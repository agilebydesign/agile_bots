...
<a id="scenario-generator-fails-when-bot-config-malformed"></a>
### Scenario: [Generator fails when bot config malformed](#scenario-generator-fails-when-bot-config-malformed) ()
