...
**User:** User
**Path:** [🎯 Invoke Bot](../..) / [⚙️ Perform Behavior Action](..) / [⚙️ Perform Action Using CLI](..) / [⚙️ Display Clarify Instructions Through REPL](.)  
...
### Scenario: [Display key questions from guardrails](#scenario-display-key-questions-from-guardrails) ()
