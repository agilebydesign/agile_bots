...
**User:** User
**Path:** [🎯 Invoke Bot](../..) / [⚙️ Perform Behavior Action](..) / [⚙️ Perform Action Using CLI](..) / [⚙️ Display Build Instructions Through REPL](.)  
...
### Scenario: [Display knowledge graph with scope filter](#scenario-display-knowledge-graph-with-scope-filter) ()
