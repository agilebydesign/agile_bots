...
**Navigation:** [📄‹ Story Map](../../../../story-map.drawio) | [Test](/test/invoke_bot/edit_story_map/test_manage_story_scope.py#L419)
...
### Scenario: [Action execution uses active scope via CLI](#scenario-action-execution-uses-active-scope-via-cli) (happy_path)  | [Test](/test/invoke_bot/edit_story_map/test_manage_story_scope.py#L432)
