...
class TestReportIncrementChanges(BaseReportDiagramTest):
    ...
    def test_story_moved_between_lanes_detected_as_move(self, tmp_path):
        ...
        # Story move between increments should be in increment_moves
    ...
    def test_user_created_lane_detected_by_geometry(self, tmp_path):
        ...
        # Phase 3 should be detected as a new increment (in increment_order)
        increment_names = [inc['name'] for inc in report.increment_order]
        assert 'Phase 3' in increment_names
