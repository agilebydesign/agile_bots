 ...
 */
function toggleIncrementView(message, botPanel) {
 ...
 * @returns {boolean} true if panel should update
 */
function switchViewMode(message, botPanel) {
 ...
 */
async function copyNodeToClipboard(message, botPanel) {
    ...
    if (action === 'json') {
        vscode.window.withProgress({
            ...
            try {
                ...
                handleError(err, 'copy node to clipboard');
            }
        });
    } else {
        doCopy().catch((err) => {
 ...
 * @returns {boolean} false - handles own async flow
 */
async function copyIncrementStoriesJson(message, botPanel) {
    ...
    vscode.window.withProgress({
        ...
        try {
            ...
            handleError(err, 'copy increment stories');
        }
    });
 ...
 */
async function renameNode(message, botPanel) {
