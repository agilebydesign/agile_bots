 ...
 */
async function getBehaviorRules(message, botPanel) {
 ...
 * @param {BotPanel} botPanel 
 */
async function executeNavigationCommand(message, botPanel) {
 ...
 * @param {BotPanel} botPanel 
 */
async function setExecutionMode(message, botPanel) {
 ...
 * @param {BotPanel} botPanel 
 */
async function setBehaviorExecuteMode(message, botPanel) {
 ...
 * @param {BotPanel} botPanel 
 */
async function setBehaviorSpecialInstructions(message, botPanel) {
 ...
 * @param {BotPanel} botPanel 
 */
async function setActionSpecialInstructions(message, botPanel) {
 ...
 * @param {BotPanel} botPanel 
 */
async function navigateToBehavior(message, botPanel) {
    if (!message.behaviorName) {
        return false;
    }
 ...
 * @param {BotPanel} botPanel 
 */
async function submitWorkspaceBehaviorInstructions(message, botPanel) {
 ...
 * @param {BotPanel} botPanel 
 */
async function navigateToAction(message, botPanel) {
 ...
 * @param {BotPanel} botPanel 
 */
async function navigateAndExecute(message, botPanel) {
...
module.exports = {
    ...
    setExecutionMode,
    setBehaviorExecuteMode,
    setBehaviorSpecialInstructions,
    setActionSpecialInstructions,
    navigateToBehavior,
    submitWorkspaceBehaviorInstructions,
    navigateToAction,
    navigateAndExecute,
}
