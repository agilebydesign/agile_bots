"""
Given State Not Actions Scanner

Rule: given_describes_state_not_actions

Validates that Given steps describe initial state, not actions.
Actions belong in When steps, not Given steps.
"""
