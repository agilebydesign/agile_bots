"""
Scenario Specific Given Scanner

Rule: scenario_steps_start_with_scenario_specific_given

Validates that each scenario starts with a Given step, not When.
The first step after background should establish scenario-specific context.
"""
